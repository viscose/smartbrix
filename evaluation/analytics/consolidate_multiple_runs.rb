...
perfomance_data = nil
csv_file = './normalised_results/vulnerabilities.csv'
csv_digest = './normalised_results/vulnerabilities_digest.csv'
csv_condensed = './normalised_results/vulnerabilities_condensed.csv'
